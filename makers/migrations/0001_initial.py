# Generated by Django 3.2.8 on 2021-10-13 16:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "idcard",
                    models.ImageField(blank=True, null=True, upload_to="idcard/"),
                ),
                (
                    "bankbook_image",
                    models.ImageField(blank=True, null=True, upload_to="bankbook/"),
                ),
                ...
                (
                    "available_schedule",
                    models.ManyToManyField(blank=True, to="makers.Available_schedule"),
                ),
                (
                    "available_service",
                    models.ManyToManyField(blank=True, to="makers.Available_service"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tour",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="makers.tour"
                    ),
                ),
            ],
            options={
